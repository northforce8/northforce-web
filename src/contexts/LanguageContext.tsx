...
const translations: Record<string, Record<Language, string>> = {
  ...
  // DELIVERY PAGES - Projects
  'projects.title': { en: 'Projects', sv: 'Projekt' },
  'projects.description': { en: 'Manage customer projects and deliveries', sv: 'Hantera kundprojekt och leveranser' },
  'projects.add': { en: 'Add Project', sv: 'Lägg till projekt' },
  'projects.loading': { en: 'Loading projects...', sv: 'Laddar projekt...' },
  'projects.error.load': { en: 'Failed to load projects. Please try again.', sv: 'Kunde inte ladda projekt. Försök igen.' },
  'projects.error.auth': { en: 'Access denied or session expired. Please log in again.', sv: 'Åtkomst nekad eller session utgången. Logga in igen.' },
  'projects.search': { en: 'Search projects...', sv: 'Sök projekt...' },
  'projects.filter.status': { en: 'All Statuses', sv: 'Alla statusar' },
  'projects.filter.customer': { en: 'All Customers', sv: 'Alla kunder' },
  'projects.status.planning': { en: 'Planning', sv: 'Planering' },
  'projects.status.active': { en: 'Active', sv: 'Aktiv' },
  'projects.status.on_hold': { en: 'On Hold', sv: 'Pausad' },
  'projects.status.completed': { en: 'Completed', sv: 'Slutförd' },
  'projects.status.cancelled': { en: 'Cancelled', sv: 'Avbruten' },
  'projects.empty': { en: 'No projects found', sv: 'Inga projekt hittades' },
  'projects.empty.create': { en: 'Create your first project', sv: 'Skapa ditt första projekt' },
  'projects.build_marker': { en: 'Build', sv: 'Byggversion' },

  // DELIVERY PAGES - Time Reporting
  'time.title': { en: 'Time Reporting', sv: 'Tidsrapportering' },
  'time.description': { en: 'Track and manage time entries', sv: 'Spåra och hantera tidsrapporter' },
  'time.add': { en: 'Add Time Entry', sv: 'Lägg till tidsrapport' },
  'time.loading': { en: 'Loading time entries...', sv: 'Laddar tidsrapporter...' },
  'time.error.load': { en: 'Failed to load time reporting. Please try again.', sv: 'Kunde inte ladda tidsrapportering. Försök igen.' },
  'time.period.week': { en: 'This Week', sv: 'Denna vecka' },
  'time.period.month': { en: 'This Month', sv: 'Denna månad' },
  'time.period.all': { en: 'All Time', sv: 'All tid' },
  'time.empty': { en: 'No time entries found', sv: 'Inga tidsrapporter hittades' },
  'time.empty.create': { en: 'Log your first hours', sv: 'Logga dina första timmar' },
  'time.build_marker': { en: 'Build', sv: 'Byggversion' },

  // DELIVERY PAGES - Planning
  'planning.title': { en: 'Calendar & Planning', sv: 'Kalender & Planering' },
  'planning.description': { en: 'Manage capacity and resource planning', sv: 'Hantera kapacitet och resursplanering' },
  'planning.add': { en: 'Add Capacity', sv: 'Lägg till kapacitet' },
  'planning.loading': { en: 'Loading planning data...', sv: 'Laddar planeringsdata...' },
  'planning.error.load': { en: 'Failed to load planning data. Please try again.', sv: 'Kunde inte ladda planeringsdata. Försök igen.' },
  'planning.view.week': { en: 'Week', sv: 'Vecka' },
  'planning.view.month': { en: 'Month', sv: 'Månad' },
  'planning.view.quarter': { en: 'Quarter', sv: 'Kvartal' },
  'planning.empty': { en: 'No capacity entries found', sv: 'Inga kapacitetsplaner hittades' },
  'planning.empty.create': { en: 'Create your first capacity plan', sv: 'Skapa din första kapacitetsplan' },
  'planning.build_marker': { en: 'Build', sv: 'Byggversion' },

  // DELIVERY PAGES - Notes
  'notes.title': { en: 'Notes', sv: 'Anteckningar' },
  'notes.description': { en: 'Manage customer notes and documentation', sv: 'Hantera kundanteckningar och dokumentation' },
  'notes.add': { en: 'Add Note', sv: 'Lägg till anteckning' },
  'notes.loading': { en: 'Loading notes...', sv: 'Laddar anteckningar...' },
  'notes.error.load': { en: 'Failed to load notes. Please try again.', sv: 'Kunde inte ladda anteckningar. Försök igen.' },
  'notes.type.general': { en: 'General', sv: 'Allmän' },
  'notes.type.meeting': { en: 'Meeting', sv: 'Möte' },
  'notes.type.decision': { en: 'Decision', sv: 'Beslut' },
  'notes.visibility.admin_only': { en: 'Admin Only', sv: 'Endast Admin' },
  'notes.visibility.shared': { en: 'Shared', sv: 'Delad' },
  'notes.empty': { en: 'No notes found', sv: 'Inga anteckningar hittades' },
  'notes.empty.create': { en: 'Create your first note', sv: 'Skapa din första anteckning' },
  'notes.build_marker': { en: 'Build', sv: 'Byggversion' },
  ...
  'common.view': { en: 'View', sv: 'Visa' },
  'common.create': { en: 'Create', sv: 'Skapa' },
  'common.update': { en: 'Update', sv: 'Uppdatera' },
  'common.close': { en: 'Close', sv: 'Stäng' },
  'common.back': { en: 'Back', sv: 'Tillbaka' },
  'common.next': { en: 'Next', sv: 'Nästa' },
  'common.previous': { en: 'Previous', sv: 'Föregående' },
  'common.search': { en: 'Search', sv: 'Sök' },
  'common.filter': { en: 'Filter', sv: 'Filtrera' },
  'common.export': { en: 'Export', sv: 'Exportera' },
  'common.download': { en: 'Download', sv: 'Ladda ner' },
  'common.upload': { en: 'Upload', sv: 'Ladda upp' },
  'common.submit': { en: 'Submit', sv: 'Skicka' },
  'common.confirm': { en: 'Confirm', sv: 'Bekräfta' },
  'common.yes': { en: 'Yes', sv: 'Ja' },
  'common.no': { en: 'No', sv: 'Nej' },
  'common.actions': { en: 'Actions', sv: 'Åtgärder' },
  'common.status': { en: 'Status', sv: 'Status' },
  'common.type': { en: 'Type', sv: 'Typ' },
  'common.date': { en: 'Date', sv: 'Datum' },
  'common.time': { en: 'Time', sv: 'Tid' },
  'common.name': { en: 'Name', sv: 'Namn' },
  'common.email': { en: 'Email', sv: 'E-post' },
  'common.phone': { en: 'Phone', sv: 'Telefon' },
  'common.company': { en: 'Company', sv: 'Företag' },
  'common.message': { en: 'Message', sv: 'Meddelande' },
  'common.description': { en: 'Description', sv: 'Beskrivning' },
  'common.details': { en: 'Details', sv: 'Detaljer' },
  'common.settings': { en: 'Settings', sv: 'Inställningar' },
  'common.all': { en: 'All', sv: 'Alla' },
  'common.none': { en: 'None', sv: 'Ingen' },
  'common.select': { en: 'Select', sv: 'Välj' },
  'common.optional': { en: 'Optional', sv: 'Valfritt' },
  'common.required': { en: 'Required', sv: 'Obligatoriskt' },

  // Empty States
  'empty.no_data': { en: 'No data available', sv: 'Ingen data tillgänglig' },
  'empty.no_results': { en: 'No results found', sv: 'Inga resultat hittades' },
  'empty.no_items': { en: 'No items to display', sv: 'Inga objekt att visa' },
  'empty.coming_soon': { en: 'Coming soon', sv: 'Kommer snart' },
  'empty.under_construction': { en: 'Under construction', sv: 'Under uppbyggnad' },
  'empty.get_started': { en: 'Get started by creating your first item', sv: 'Kom igång genom att skapa ditt första objekt' },

  // Error States
  'error.generic': { en: 'Something went wrong', sv: 'Något gick fel' },
  'error.load_failed': { en: 'Failed to load data', sv: 'Misslyckades att ladda data' },
  'error.save_failed': { en: 'Failed to save changes', sv: 'Misslyckades att spara ändringar' },
  'error.delete_failed': { en: 'Failed to delete item', sv: 'Misslyckades att ta bort objekt' },
  'error.network': { en: 'Network error. Please check your connection.', sv: 'Nätverksfel. Kontrollera din anslutning.' },
  'error.unauthorized': { en: 'You are not authorized to access this resource', sv: 'Du har inte behörighet att komma åt denna resurs' },
  'error.not_found': { en: 'Resource not found', sv: 'Resurs hittades inte' },
  'error.try_again': { en: 'Please try again', sv: 'Försök igen' },
  'error.refresh_page': { en: 'Try refreshing the page', sv: 'Försök uppdatera sidan' },

  // Success Messages
  'success.saved': { en: 'Successfully saved', sv: 'Sparad' },
  'success.created': { en: 'Successfully created', sv: 'Skapad' },
  'success.updated': { en: 'Successfully updated', sv: 'Uppdaterad' },
  'success.deleted': { en: 'Successfully deleted', sv: 'Borttagen' },
  'success.sent': { en: 'Successfully sent', sv: 'Skickad' },

  // Status Labels
  'status.active': { en: 'Active', sv: 'Aktiv' },
  'status.inactive': { en: 'Inactive', sv: 'Inaktiv' },
  'status.pending': { en: 'Pending', sv: 'Väntande' },
  'status.completed': { en: 'Completed', sv: 'Slutförd' },
  'status.in_progress': { en: 'In Progress', sv: 'Pågående' },
  'status.cancelled': { en: 'Cancelled', sv: 'Avbruten' },
  'status.draft': { en: 'Draft', sv: 'Utkast' },
  'status.published': { en: 'Published', sv: 'Publicerad' },
  'status.archived': { en: 'Archived', sv: 'Arkiverad' },

  // Admin Portal - Dashboard
  'admin.dashboard.title': { en: 'Admin Dashboard', sv: 'Adminpanel' },
  'admin.dashboard.welcome': { en: 'Welcome back', sv: 'Välkommen tillbaka' },
  'admin.dashboard.submissions': { en: 'Submissions', sv: 'Inlämningar' },
  'admin.dashboard.total': { en: 'Total', sv: 'Totalt' },
  'admin.dashboard.new': { en: 'New', sv: 'Nya' },
  'admin.dashboard.contacted': { en: 'Contacted', sv: 'Kontaktade' },
  'admin.dashboard.qualified': { en: 'Qualified', sv: 'Kvalificerade' },
  'admin.dashboard.converted': { en: 'Converted', sv: 'Konverterade' },
  'admin.dashboard.search_placeholder': { en: 'Search by name, email, or company...', sv: 'Sök efter namn, e-post eller företag...' },
  'admin.dashboard.filter_type': { en: 'Filter by type', sv: 'Filtrera efter typ' },
  'admin.dashboard.filter_status': { en: 'Filter by status', sv: 'Filtrera efter status' },
  'admin.dashboard.export_csv': { en: 'Export CSV', sv: 'Exportera CSV' },
  'admin.dashboard.type_all': { en: 'All Types', sv: 'Alla typer' },
  'admin.dashboard.type_contact': { en: 'Contact', sv: 'Kontakt' },
  'admin.dashboard.type_booking': { en: 'Booking', sv: 'Bokning' },
  'admin.dashboard.type_newsletter': { en: 'Newsletter', sv: 'Nyhetsbrev' },
  'admin.dashboard.view_details': { en: 'View Details', sv: 'Visa detaljer' },
  'admin.dashboard.no_submissions': { en: 'No submissions found', sv: 'Inga inlämningar hittades' },
  'admin.dashboard.loading': { en: 'Loading submissions...', sv: 'Laddar inlämningar...' },
  'admin.dashboard.ai_classification': { en: 'AI Classification', sv: 'AI-klassificering' },

  // Admin Portal - Navigation
  'admin.nav.dashboard': { en: 'Dashboard', sv: 'Översikt' },
  'admin.nav.leads': { en: 'Lead Management', sv: 'Leadhantering' },
  'admin.nav.customers': { en: 'Customers', sv: 'Kunder' },
  'admin.nav.projects': { en: 'Projects', sv: 'Projekt' },
  'admin.nav.contracts': { en: 'Contracts', sv: 'Kontrakt' },
  'admin.nav.invoices': { en: 'Invoices', sv: 'Fakturor' },
  'admin.nav.time_reporting': { en: 'Time Reporting', sv: 'Tidsrapportering' },
  'admin.nav.credits': { en: 'Credits Dashboard', sv: 'Kreditöversikt' },
  'admin.nav.capacity': { en: 'Capacity Overview', sv: 'Kapacitetsöversikt' },
  'admin.nav.margin_analysis': { en: 'Margin Analysis', sv: 'Marginalanalys' },
  'admin.nav.reports': { en: 'Reports', sv: 'Rapporter' },
  'admin.nav.partners': { en: 'Partners', sv: 'Partners' },
  'admin.nav.growth_plans': { en: 'Growth Plans', sv: 'Tillväxtplaner' },
  'admin.nav.campaigns': { en: 'Campaigns', sv: 'Kampanjer' },
  'admin.nav.leadership': { en: 'Leadership', sv: 'Ledarskap' },
  'admin.nav.frameworks': { en: 'Strategic Frameworks', sv: 'Strategiska ramverk' },
  'admin.nav.okr': { en: 'OKR', sv: 'OKR' },
  'admin.nav.swot': { en: 'SWOT', sv: 'SWOT' },
  'admin.nav.bmc': { en: 'Business Model Canvas', sv: 'Business Model Canvas' },
  'admin.nav.bsc': { en: 'Balanced Scorecard', sv: 'Balanced Scorecard' },
  'admin.nav.porter': { en: 'Porter 5 Forces', sv: 'Porters 5 krafter' },
  'admin.nav.mckinsey': { en: 'McKinsey 7S', sv: 'McKinsey 7S' },
  'admin.nav.adkar': { en: 'ADKAR', sv: 'ADKAR' },
  'admin.nav.agile': { en: 'Agile', sv: 'Agile' },
  'admin.nav.lean': { en: 'Lean Startup', sv: 'Lean Startup' },
  'admin.nav.design_thinking': { en: 'Design Thinking', sv: 'Design Thinking' },
  'admin.nav.planning': { en: 'Planning', sv: 'Planering' },
  'admin.nav.best_practices': { en: 'Best Practices', sv: 'Bästa praxis' },
  'admin.nav.methodology': { en: 'Methodology', sv: 'Metodik' },
  'admin.nav.business_models': { en: 'Business Models', sv: 'Affärsmodeller' },
  'admin.nav.enterprise': { en: 'Enterprise Dashboard', sv: 'Företagspanel' },
  'admin.nav.enterprise_plans': { en: 'Enterprise Plans', sv: 'Företagsplaner' },
  'admin.nav.support': { en: 'Support', sv: 'Support' },
  'admin.nav.settings': { en: 'Settings', sv: 'Inställningar' },
  'admin.nav.health': { en: 'System Health', sv: 'Systemhälsa' },
  'admin.nav.help': { en: 'Help Center', sv: 'Hjälpcenter' },
  'admin.nav.logout': { en: 'Logout', sv: 'Logga ut' },

  // Admin - Login
  'admin.login.title': { en: 'Admin Login', sv: 'Admin-inloggning' },
  'admin.login.subtitle': { en: 'Sign in to access the admin portal', sv: 'Logga in för att komma åt adminportalen' },
  'admin.login.email': { en: 'Email address', sv: 'E-postadress' },
  'admin.login.password': { en: 'Password', sv: 'Lösenord' },
  'admin.login.button': { en: 'Sign In', sv: 'Logga in' },
  'admin.login.forgot_password': { en: 'Forgot password?', sv: 'Glömt lösenord?' },
  'admin.login.error': { en: 'Invalid email or password', sv: 'Ogiltig e-post eller lösenord' },
  'admin.login.signing_in': { en: 'Signing in...', sv: 'Loggar in...' },

  // Admin - Password Reset
  'admin.reset.title': { en: 'Reset Password', sv: 'Återställ lösenord' },
  'admin.reset.subtitle': { en: 'Enter your email to receive a reset link', sv: 'Ange din e-post för att få en återställningslänk' },
  'admin.reset.button': { en: 'Send Reset Link', sv: 'Skicka återställningslänk' },
  'admin.reset.back_to_login': { en: 'Back to login', sv: 'Tillbaka till inloggning' },
  'admin.reset.success': { en: 'Password reset email sent', sv: 'E-post för lösenordsåterställning skickad' },
  'admin.reset.error': { en: 'Failed to send reset email', sv: 'Misslyckades att skicka återställningsmail' },

  // Admin - Customers
  'admin.customers.title': { en: 'Customers', sv: 'Kunder' },
  'admin.customers.subtitle': { en: 'Manage your customer accounts', sv: 'Hantera dina kundkonton' },
  'admin.customers.add': { en: 'Add Customer', sv: 'Lägg till kund' },
  'admin.customers.search': { en: 'Search customers...', sv: 'Sök kunder...' },
  'admin.customers.name': { en: 'Customer Name', sv: 'Kundnamn' },
  'admin.customers.contact': { en: 'Contact Person', sv: 'Kontaktperson' },
  'admin.customers.credits': { en: 'Credits Balance', sv: 'Kreditsaldo' },
  'admin.customers.plan': { en: 'Plan', sv: 'Plan' },
  'admin.customers.status': { en: 'Status', sv: 'Status' },
  'admin.customers.since': { en: 'Customer Since', sv: 'Kund sedan' },
  'admin.customers.view': { en: 'View Details', sv: 'Visa detaljer' },

  // Admin - Customer Detail
  'admin.customer_detail.overview': { en: 'Customer Overview', sv: 'Kundöversikt' },
  'admin.customer_detail.info': { en: 'Customer Information', sv: 'Kundinformation' },
  'admin.customer_detail.projects': { en: 'Active Projects', sv: 'Aktiva projekt' },
  'admin.customer_detail.contracts': { en: 'Contracts', sv: 'Kontrakt' },
  'admin.customer_detail.invoices': { en: 'Recent Invoices', sv: 'Senaste fakturor' },
  'admin.customer_detail.activity': { en: 'Recent Activity', sv: 'Senaste aktivitet' },
  'admin.customer_detail.edit': { en: 'Edit Customer', sv: 'Redigera kund' },

  // Admin - Leads
  'admin.leads.title': { en: 'Lead Management', sv: 'Leadhantering' },
  'admin.leads.subtitle': { en: 'Track and manage your leads', sv: 'Följ och hantera dina leads' },
  'admin.leads.add': { en: 'Add Lead', sv: 'Lägg till lead' },
  'admin.leads.source': { en: 'Source', sv: 'Källa' },
  'admin.leads.score': { en: 'Lead Score', sv: 'Lead-poäng' },
  'admin.leads.assign': { en: 'Assign to', sv: 'Tilldela till' },
  'admin.leads.follow_up': { en: 'Follow-up Date', sv: 'Uppföljningsdatum' },

  // Admin - Contracts
  'admin.contracts.title': { en: 'Contracts', sv: 'Kontrakt' },
  'admin.contracts.subtitle': { en: 'Manage customer contracts', sv: 'Hantera kundkontrakt' },
  'admin.contracts.create': { en: 'Create Contract', sv: 'Skapa kontrakt' },
  'admin.contracts.number': { en: 'Contract Number', sv: 'Kontraktsnummer' },
  'admin.contracts.start_date': { en: 'Start Date', sv: 'Startdatum' },
  'admin.contracts.end_date': { en: 'End Date', sv: 'Slutdatum' },
  'admin.contracts.value': { en: 'Contract Value', sv: 'Kontraktsvärde' },
  'admin.contracts.renewal': { en: 'Renewal Date', sv: 'Förnyelsedatum' },
  'admin.contracts.view_pdf': { en: 'View PDF', sv: 'Visa PDF' },

  // Admin - Invoices
  'admin.invoices.title': { en: 'Invoices', sv: 'Fakturor' },
  'admin.invoices.subtitle': { en: 'Manage customer invoices', sv: 'Hantera kundfakturor' },
  'admin.invoices.create': { en: 'Create Invoice', sv: 'Skapa faktura' },
  'admin.invoices.number': { en: 'Invoice Number', sv: 'Fakturanummer' },
  'admin.invoices.amount': { en: 'Amount', sv: 'Belopp' },
  'admin.invoices.due_date': { en: 'Due Date', sv: 'Förfallodatum' },
  'admin.invoices.paid': { en: 'Paid', sv: 'Betald' },
  'admin.invoices.unpaid': { en: 'Unpaid', sv: 'Obetald' },
  'admin.invoices.overdue': { en: 'Overdue', sv: 'Försenad' },
  'admin.invoices.send': { en: 'Send Invoice', sv: 'Skicka faktura' },

  // Admin - Time Reporting
  'admin.time.title': { en: 'Time Reporting', sv: 'Tidsrapportering' },
  'admin.time.subtitle': { en: 'Log work hours and track time', sv: 'Logga arbetstid och följ tid' },
  'admin.time.log_time': { en: 'Log Time', sv: 'Logga tid' },
  'admin.time.project': { en: 'Project', sv: 'Projekt' },
  'admin.time.task': { en: 'Task', sv: 'Uppgift' },
  'admin.time.hours': { en: 'Hours', sv: 'Timmar' },
  'admin.time.credits_consumed': { en: 'Credits Consumed', sv: 'Förbrukade krediter' },
  'admin.time.work_type': { en: 'Work Type', sv: 'Arbetstyp' },
  'admin.time.notes': { en: 'Notes', sv: 'Anteckningar' },

  // Admin - Strategic Frameworks
  'admin.frameworks.title': { en: 'Strategic Frameworks', sv: 'Strategiska ramverk' },
  'admin.frameworks.subtitle': { en: 'Overview of all strategic frameworks', sv: 'Översikt av alla strategiska ramverk' },
  'admin.frameworks.select': { en: 'Select a framework to get started', sv: 'Välj ett ramverk för att komma igång' },

  // Admin - OKR
  'admin.okr.title': { en: 'OKR Management', sv: 'OKR-hantering' },
  'admin.okr.subtitle': { en: 'Objectives and Key Results', sv: 'Mål och nyckelresultat' },
  'admin.okr.create': { en: 'Create OKR', sv: 'Skapa OKR' },
  'admin.okr.objective': { en: 'Objective', sv: 'Mål' },
  'admin.okr.key_result': { en: 'Key Result', sv: 'Nyckelresultat' },
  'admin.okr.progress': { en: 'Progress', sv: 'Framsteg' },
  'admin.okr.owner': { en: 'Owner', sv: 'Ägare' },
  'admin.okr.quarter': { en: 'Quarter', sv: 'Kvartal' },
  'admin.okr.year': { en: 'Year', sv: 'År' },

  // Admin - SWOT
  'admin.swot.title': { en: 'SWOT Analysis', sv: 'SWOT-analys' },
  'admin.swot.subtitle': { en: 'Strengths, Weaknesses, Opportunities, Threats', sv: 'Styrkor, Svagheter, Möjligheter, Hot' },
  'admin.swot.strengths': { en: 'Strengths', sv: 'Styrkor' },
  'admin.swot.weaknesses': { en: 'Weaknesses', sv: 'Svagheter' },
  'admin.swot.opportunities': { en: 'Opportunities', sv: 'Möjligheter' },
  'admin.swot.threats': { en: 'Threats', sv: 'Hot' },
