          ...
          <div className="flex-1 overflow-y-auto py-4">
            <nav className="px-3">
              ...
              {filteredNavGroups.map((group, groupIndex) => (
                <div key={group.label} className={groupIndex > 0 ? 'mt-6 pt-6 border-t border-gray-200' : 'mt-6'}>
                  <div className="px-3 mb-3 text-sm font-semibold text-gray-700 uppercase tracking-wide">
                    {group.label}
                  </div>
