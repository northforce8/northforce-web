  ...
  useEffect(() => {
    const loadDashboard = async () => {
      try {
        ...
        setError(err instanceof Error ? err.message : 'Kunde inte ladda instrumentpanelens data. Försök igen.');
      } finally {
        setLoading(false);
      }
    };
      ...
      <div>
        <div className="flex items-center justify-center h-screen">
          <div className="text-center max-w-md">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Kunde inte Ladda Instrumentpanel</h2>
