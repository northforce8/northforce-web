...
export default function AgileDetailPage() {
  ...
  const handleDelete = async () => {
    if (!confirm('Are you sure you want to delete this Agile transformation?')) return;
    ...
    return (
      <div className="max-w-7xl mx-auto p-6">
        <div className="text-center py-12 bg-yellow-50 border border-yellow-200 rounded-lg">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Transformation not found</h3>
          <button
            onClick={() => navigate('/admin/partner-portal/strategic-frameworks/agile')}
            className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
          >
            Back to Agile Transformations
          </button>
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <PageHeader
          ...
          description={transformation.customer_name || 'Agile Transformation'}
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="p-6 bg-gradient-to-br from-green-50 to-green-100 border-green-200">
          <h3 className="text-sm font-medium text-gray-600 mb-2">Sprint Length</h3>
          <p className="text-2xl font-bold text-green-900">{transformation.sprint_length} weeks</p>
        </Card>

        <Card className="p-6 bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
          <h3 className="text-sm font-medium text-gray-600 mb-2">Team Velocity</h3>
          <p className="text-2xl font-bold text-purple-900">{transformation.team_velocity} points</p>
        </Card>
      </div>

      {transformation.notes && (
        <Card className="p-6">
          <h3 className="font-semibold text-gray-900 mb-3">Transformation Notes</h3>
