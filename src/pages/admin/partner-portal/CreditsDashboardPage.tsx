  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Credits & Capacity Engine</h1>
          <p className="text-gray-600 mt-1">Monitor credits consumption, burn rate, and capacity utilization</p>
        </div>
        <button
